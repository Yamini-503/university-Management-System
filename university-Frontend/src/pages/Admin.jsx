            ...
            {isCourseDropdownOpen && (
              <ul style={dropdownUlStyles}>
                <li style={dropdownLiStyles}>
                  <Link to="/admin/managecourse/courseform" style={linkStyles}>
                    Add Course
                  </Link>
                </li>
                <li style={dropdownLiStyles}>
                  <Link to="/admin/managecourse/courseview" style={linkStyles}>
                    View Courses
                  </Link>
                </li>
              </ul>
          ...
          <li>
            ...
            {isDepartmentDropdownOpen && (
              <ul style={dropdownUlStyles}>
                <li style={dropdownLiStyles}>
                  <Link
                    to="/admin/managedepartment/departmentform"
                    style={linkStyles}
                  >
                    Add Department
                  </Link>
                ...
                <li style={dropdownLiStyles}>
                  <Link
                    to="/admin/managedepartment/departmentview"
                    style={linkStyles}
                  >
                    View Departments
                  </Link>
          ...
          <li>
            ...
            {isStudentDropdownOpen && (
              <ul style={dropdownUlStyles}>
                <li style={dropdownLiStyles}>
                  <Link
                    to="/admin/managestudent/studentform"
                    style={linkStyles}
                  >
                    Add Student
                  </Link>
                ...
                <li style={dropdownLiStyles}>
                  <Link
                    to="/admin/managestudent/studentview"
                    style={linkStyles}
                  >
                    View Students
                  </Link>
          ...
          <li>
            ...
            {isFacultyDropdownOpen && (
              <ul style={dropdownUlStyles}>
                <li style={dropdownLiStyles}>
                  <Link
                    to="/admin/managefaculty/facultyform"
                    style={linkStyles}
                  >
                    Add Faculty
                  </Link>
                ...
                <li style={dropdownLiStyles}>
                  <Link
                    to="/admin/managefaculty/facultyview"
                    style={linkStyles}
                  >
                    View Faculty
                  </Link>
